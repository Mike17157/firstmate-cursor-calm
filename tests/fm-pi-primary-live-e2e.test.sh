...
run_native_ahoy_regressions() {
  ...
  cp "$ROOT/.pi/extensions/lib/fm-jev-compaction.ts" "$AHOY_PROJECT/.pi/extensions/lib/"
  cp \
...
cp "$ROOT/.pi/extensions/lib/fm-jev-compaction.ts" "$PROJECT/.pi/extensions/lib/fm-jev-compaction.ts"
