...
config/cursor-calm  Cursor Calm quiet-mode preference (fork experiment); LOCAL, gitignored, and not inherited; see docs/configuration.md "Cursor Calm preference" and docs/cursor-calm.md
